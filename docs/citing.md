...
title: Cite ORCA
description: >-
  How to cite ORCA (Open RF Integrated Circuit Automation) in your research:
  BibTeX entry for the SBCCI 2026 paper, authors, license and acknowledgements.
---
...
The GitHub repository also ships a [`CITATION.cff`](https://github.com/DI-PASSIONATE/ORCA/blob/main/CITATION.cff) file, so you can use GitHub's **Cite this repository** button to export APA or BibTeX.

## License

ORCA is released under the [Apache License 2.0](https://github.com/DI-PASSIONATE/ORCA/blob/main/LICENSE).

## Acknowledgements

This work was supported by the Bundesministerium für Forschung, Technologie und Raumfahrt (BMFTR) under the [DI-PASSIONATE](https://www.elektronikforschung.de/projekte/di-passionate) project. We thank our colleagues at the [LITES](https://www.lites.tf.fau.de/) institute for their feedback and support during development. Special thanks to the open-source community for providing the tools and libraries that made this project possible, including but not limited to:
